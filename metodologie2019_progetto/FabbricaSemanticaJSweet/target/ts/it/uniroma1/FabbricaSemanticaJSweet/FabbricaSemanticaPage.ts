...
namespace it.uniroma1.FabbricaSemanticaJSweet {
    ...
    export class FabbricaSemanticaPage {
         ...
         * @private
         */
        /*private*/ createMenuButton(actualPage : boolean, text : string) : HTMLButtonElement {
         ...
         * @private
         */
        /*private*/ createActualButton(text : string) : HTMLButtonElement {
         ...
         * @private
         */
        /*private*/ createOtherButton(text : string) : HTMLButtonElement {
