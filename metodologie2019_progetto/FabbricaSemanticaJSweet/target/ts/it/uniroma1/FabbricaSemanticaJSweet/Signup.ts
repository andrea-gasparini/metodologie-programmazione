...
namespace it.uniroma1.FabbricaSemanticaJSweet {
    export class Signup extends it.uniroma1.FabbricaSemanticaJSweet.FabbricaSemanticaPage {
        ...
        public constructor(pageName : it.uniroma1.FabbricaSemanticaJSweet.PageType) {
            super(pageName);
            let firstCheckboxDiv : HTMLDivElement = new it.uniroma1.FabbricaSemanticaJSweet.HTMLElementsBuilders.HTMLDivElementBuilder().addClass("checkbox-text").toHTMLElement();
            let firstCheckbox : HTMLInputElement = new it.uniroma1.FabbricaSemanticaJSweet.HTMLElementsBuilders.HTMLInputElementBuilder().addName("first-checkbox").addType("checkbox").toHTMLElement();
            let firstCheckboxSpan : HTMLSpanElement = new it.uniroma1.FabbricaSemanticaJSweet.HTMLElementsBuilders.HTMLSpanElementBuilder().addCss("margin-left: 5px;").addText("English").toHTMLElement();
            let secondCheckboxDiv : HTMLDivElement = new it.uniroma1.FabbricaSemanticaJSweet.HTMLElementsBuilders.HTMLDivElementBuilder().addClass("checkbox-text").toHTMLElement();
            let secondCheckbox : HTMLInputElement = new it.uniroma1.FabbricaSemanticaJSweet.HTMLElementsBuilders.HTMLInputElementBuilder().addName("second-checkbox").addType("checkbox").toHTMLElement();
            let secondCheckboxSpan : HTMLSpanElement = new it.uniroma1.FabbricaSemanticaJSweet.HTMLElementsBuilders.HTMLSpanElementBuilder().addCss("margin-left: 5px;").addText("Italian").toHTMLElement();
        ...
        /*private*/ createOtherLanguageDiv() : HTMLDivElement {
            ...
            let otherLanguageSelect : it.uniroma1.FabbricaSemanticaJSweet.HTMLElementsBuilders.HTMLSelectElementBuilder = new it.uniroma1.FabbricaSemanticaJSweet.HTMLElementsBuilders.HTMLSelectElementBuilder().addClass("level-select");
