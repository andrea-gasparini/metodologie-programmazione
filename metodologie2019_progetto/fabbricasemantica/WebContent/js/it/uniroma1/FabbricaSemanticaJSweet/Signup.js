        ...
        (function (FabbricaSemanticaJSweet) {
            class Signup extends it.uniroma1.FabbricaSemanticaJSweet.FabbricaSemanticaPage {
                constructor(pageName) {
                    super(pageName);
                    let firstCheckboxDiv = new it.uniroma1.FabbricaSemanticaJSweet.HTMLElementsBuilders.HTMLDivElementBuilder().addClass("checkbox-text").toHTMLElement();
                    let firstCheckbox = new it.uniroma1.FabbricaSemanticaJSweet.HTMLElementsBuilders.HTMLInputElementBuilder().addName("first-checkbox").addType("checkbox").toHTMLElement();
                    let firstCheckboxSpan = new it.uniroma1.FabbricaSemanticaJSweet.HTMLElementsBuilders.HTMLSpanElementBuilder().addCss("margin-left: 5px;").addText("English").toHTMLElement();
                    let secondCheckboxDiv = new it.uniroma1.FabbricaSemanticaJSweet.HTMLElementsBuilders.HTMLDivElementBuilder().addClass("checkbox-text").toHTMLElement();
                    let secondCheckbox = new it.uniroma1.FabbricaSemanticaJSweet.HTMLElementsBuilders.HTMLInputElementBuilder().addName("second-checkbox").addType("checkbox").toHTMLElement();
                    let secondCheckboxSpan = new it.uniroma1.FabbricaSemanticaJSweet.HTMLElementsBuilders.HTMLSpanElementBuilder().addCss("margin-left: 5px;").addText("Italian").toHTMLElement();
                ...
                /*private*/ createOtherLanguageDiv() {
                    let otherLanguageDiv = new it.uniroma1.FabbricaSemanticaJSweet.HTMLElementsBuilders.HTMLDivElementBuilder().addClass("other-language horizontal container").toHTMLElement();
                    let otherLanguageSelect = new it.uniroma1.FabbricaSemanticaJSweet.HTMLElementsBuilders.HTMLSelectElementBuilder().addClass("level-select");
                    ...
                    $(otherLanguageDiv).append(new it.uniroma1.FabbricaSemanticaJSweet.HTMLElementsBuilders.HTMLInputElementBuilder().addClass("language-field").toHTMLElement(), otherLanguageSelect.toHTMLElement());
            ...
            FabbricaSemanticaJSweet.Signup = Signup;
